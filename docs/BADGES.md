...
Private or nonexistent run IDs return `404`. Badge color reflects the sign of the reported return:
green for positive, gray for zero, and red for negative. The badge represents benchmark evidence.
